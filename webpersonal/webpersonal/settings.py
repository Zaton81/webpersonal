...
SECRET_KEY = 'django-insecure-q1ybt-bb6#pqgou!5b5h5^@%5djmsugbsd4vt$%zu2)wbq!@u#'
...
#definimos los lenguajes que vamos a soportar
LANGUAGES = [
    ('es', _('Spanish')),
    ('en', _('English')),
]
#definimos la ruta donde se guardarán los archivos de traducción
LOCALE_PATHS = [
